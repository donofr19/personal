...
ax[0].invert_xaxis() # HR diagram
ax[0].set_xlabel('log(Teff/K)')
ax[0].set_ylabel('log(L/Lsun)')
ax[0].set_title('Mass Range of 0.1MSun-0.3MSun; pp_factor=1.0')
...
ax[1].set_title('Mass Range of 0.1MSun-0.3MSun; pp_factor=1.0')

fig.savefig('Part10_pp1.pdf',format='pdf',bbox_inches='tight',facecolor='white')
